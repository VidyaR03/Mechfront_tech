...
'</div>'+
'</div>';
$(".links-info-discount").append(experiencecontent);return false;});
...
'<img src="../static/assets/img/icons/siderbar-icon1.svg" class="feather-five" alt="">'+
...
'<div class="tooltip-five">'+
'<img src="../static/assets/img/icons/siderbar-icon3.svg" class="feather-five" alt="">'+
...
'<img src="../static/assets/img/logo.png" alt="Logo" class="img-flex">'+
'</a>'+
'</div>'+
'</div>'+
'<div class="col-xl-6 col-sm-6 col-12">'+
'<a class="btn-closed" href="#"><img class="img-fliud" src="../static/assets/img/icons/sidebar-delete-icon.svg" alt="demo"></a>'+
'</div>'+
'</div>'+
'</div>'+
'</div>'+
...
'<img class="img-fliud" src="../static/assets/img/demo-one.png" alt="demo">'+
'</div>'+
'<div class="row">'+
...
'<div class="col-xl-6 col-sm-6 col-12">'+
'<div class="sidebar-image align-center">'+
'<img class="img-fliud" src="../static/assets/img/demo-two.png" alt="demo">'+
'</div>'+
'<div class="row">'+
'<div class="col-lg-6 layout">'+
...
'<div class="col-xl-6 col-sm-6 col-12">'+
'<div class="sidebar-image align-center">'+
'<img class="img-fliud" src="../static/assets/img/demo-three.png" alt="demo">'+
'</div>'+
'<div class="row">'+
'<div class="col-lg-6 layout">'+
...
'<div class="col-xl-6 col-sm-6 col-12">'+
'<div class="sidebar-image align-center">'+
'<img class="img-fliud" src="../static/assets/img/demo-four.png" alt="demo">'+
'</div>'+
'<div class="row">'+
'<div class="col-lg-6 layout">'+
...
'<div class="col-xl-6 col-sm-6 col-12">'+
'<div class="sidebar-image align-center">'+
'<img class="img-fliud" src="../static/assets/img/demo-five.png" alt="demo">'+
'</div>'+
'<div class="row">'+
'<div class="col-lg-6 layout">'+
...
'<a href="index.html">'+
'<button type="button" class="sidebar-but"><img src="../static/assets/img/icons/reset-icon.svg" alt="reset" class="reset-icon">'+
...
'<img class="img-fliud" src="../static/assets/img/layout-one.png" alt="layout">'+
'</div>'+
'<div class="row">'+
...
'<div class="col-xl-3 col-sm-6">'+
'<div class="sidebar-image-one align-center">'+
'<img class="img-fliud" src="../static/assets/img/layout-two.png" alt="layout">'+
'</div>'+
'<div class="row">'+
'<div class="col-lg-6 setting">'+
...
'<div class="col-xl-3 col-sm-6">'+
'<div class="sidebar-image-one align-center">'+
'<img class="img-fliud" src="../static/assets/img/layout-three.png" alt="layout">'+
'</div>'+
'<div class="row">'+
'<div class="col-lg-6 setting">'+
...
'<div class="col-xl-3 col-sm-6">'+
'<div class="sidebar-image-one align-center">'+
'<img src="../static/assets/img/layout-four.png" alt="layout">'+
'</div>'+
'<div class="row">'+
'<div class="col-lg-6 setting">'+
...
'<div class="col-xl-3 col-sm-6">'+
'<div class="sidebar-image-one align-center">'+
'<img src="../static/assets/img/layout-five.png" alt="layout">'+
'</div>'+
'<div class="row">'+
'<div class="col-lg-6 setting">'+
...
function getautocomplete(inputname,coraddress,corgstno)
{
    $('#'+inputname).autocomplete({
	    source: function( request, response ) 
	    {
	        $.ajax({
	        	url : '<?=base_url()?>index.php/ajaxdata/getConsignorbyname ',
	          	dataType: "json",
	          	type: "POST",
		        data: {
	    ...
	    select: function( event, ui ) 
	    {
	    	...
	    	$('#'+coraddress).val(names[1]);
	    	$('#'+corgstno).val(names[2]);
	    }
    });
}