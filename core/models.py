...
class customer(models.Model):
    ...
    shipping_1_attention = models.CharField(max_length=100, blank=True, null=True)
    shipping_1_street = models.CharField(max_length=100, blank=True, null=True)
    ...
    shipping_2_attention = models.CharField(max_length=100, blank=True, null=True)
    shipping_2_street = models.CharField(max_length=100, blank=True, null=True)
    ...
    shipping_3_attention = models.CharField(max_length=100, blank=True, null=True)
    shipping_3_street = models.CharField(max_length=100, blank=True, null=True)
    ...
    shipping_4_attention = models.CharField(max_length=100, blank=True, null=True)
    shipping_4_street = models.CharField(max_length=100, blank=True, null=True)
...
class vendor(models.Model):
    ...
    balance = models.CharField(max_length=100, default=0.00,null=True)
    ...
    vendor_street = models.CharField(max_length=100, blank=True, null=True)
...
class expense_vendor(models.Model):
    ...
    ex_gst_number = models.CharField(max_length=100, null=True,blank=True)
...
class quotation(models.Model):
    ...
    q_sub_total = models.CharField(max_length=100,blank=True)
    q_cgstper = models.CharField(max_length=100,blank=True)
    q_cgstval = models.CharField(max_length=100,blank=True)
    q_sgstper = models.CharField(max_length=100,blank=True)
    q_sgstval = models.CharField(max_length=100,blank=True)
    q_igstper = models.CharField(max_length=100,blank=True)
    q_igstval = models.CharField(max_length=100,blank=True)
    q_adjustment = models.CharField(max_length=100,blank=True)
    q_sale_of_good = models.CharField(max_length=100,blank=True)
    q_note = models.TextField(blank=True)
    q_total = models.CharField(max_length=100,blank=True)
    ...
    q_freight_amount = models.CharField(max_length=100,blank=True)
    q_freight_percentage = models.CharField(max_length=100,blank=True)
    gst_option= models.CharField(null=True,max_length=100)
    q_packaging_forwording_percentage_amt = models.CharField(max_length=512,blank=True)
    q_freight_percentage_amt = models.CharField(max_length=100,blank=True)
    ...
    q_freight_percentage_amt_amt = models.CharField(max_length=100,blank=True)
...
class inventory(models.Model):
    ...
    # intrastate_gst = models.CharField(max_length=100)
    # interstate_gst = models.CharField(max_length=100)
    ...
    division_no = models.CharField(max_length=100,null=True,blank=True)
...
class sales_order(models.Model):
    ...
    # so_freight = models.CharField(max_length=100,blank=True)
    so_total = models.CharField(max_length=100,blank=True)
    so_dc_no_1 = models.CharField(max_length=100,blank = True)
    so_dc_date_1 = models.CharField(max_length=100,blank = True)
    so_dc_no_2 = models.CharField(max_length=100,blank = True)
    so_dc_date_2 = models.CharField(max_length=100,blank = True)
    so_dc_no_3 = models.CharField(max_length=100,blank = True)
    so_dc_date_3 = models.CharField(max_length=100,blank = True)
    so_dc_no_4 = models.CharField(max_length=100,blank = True)
    so_dc_date_4 = models.CharField(max_length=100,blank = True)
    so_invoce_no_1 = models.CharField(max_length=100,blank = True)
    so_invoce_date_1 = models.CharField(max_length=100,blank = True)
    so_invoce_no_2 = models.CharField(max_length=100,blank = True)
    so_invoce_date_2 = models.CharField(max_length=100,blank = True)
    so_invoce_no_3 = models.CharField(max_length=100,blank = True)
    so_invoce_date_3 = models.CharField(max_length=100,blank = True)
    so_invoce_no_4 = models.CharField(max_length=100,blank = True)
    so_invoce_date_4 = models.CharField(max_length=100,blank = True)
    so_ewaybill_no_1 = models.CharField(max_length=100,blank = True)
    so_ewaybill_no_2 = models.CharField(max_length=100,blank = True)
    so_ewaybill_no_3 = models.CharField(max_length=100,blank = True)
    so_ewaybill_no_4 = models.CharField(max_length=100,blank = True)
    so_sub_total = models.CharField(max_length=100,blank=True)
    so_cgstper = models.CharField(max_length=100,blank=True)
    so_cgstval = models.CharField(max_length=100,blank=True)
    so_sgstper = models.CharField(max_length=100,blank=True)
    so_sgstval = models.CharField(max_length=100,blank=True)
    so_igstper = models.CharField(max_length=100,blank=True)
    so_igstval = models.CharField(max_length=100,blank=True)
    so_adjustment = models.CharField(max_length=100,blank=True)
    so_sale_of_good = models.CharField(max_length=100,blank=True)
    so_note = models.TextField(blank=True)
    gst_option = models.CharField(max_length=100,blank=True)
    ...
    so_freight_amount = models.CharField(max_length=100,blank=True)
    so_freight_percentage = models.CharField(max_length=100,blank=True)
    so_packaging_forwording_percentage_amt = models.CharField(max_length=512,blank=True)
    so_freight_percentage_amt = models.CharField(max_length=100,blank=True)
    ...
    so_freight_amt_amt = models.CharField(max_length=100,blank=True,null=True)
    so_order_confirmation_no = models.CharField(max_length=100,blank=True,null=True)
...
class delivery_challan(models.Model):
    ...
    dc_landing_LR_RR_No = models.CharField(max_length=100,blank=True)
    dc_sub_total = models.CharField(max_length=100,blank=True)
    dc_cgstper = models.CharField(max_length=100,blank=True)
    dc_cgstval = models.CharField(max_length=100,blank=True)
    dc_sgstper = models.CharField(max_length=100,blank=True)
    dc_sgstval = models.CharField(max_length=100,blank=True)
    dc_igstper = models.CharField(max_length=100,blank=True)
    dc_igstval = models.CharField(max_length=100,blank=True)
    dc_adjustment = models.CharField(max_length=100,blank=True)
    dc_sale_of_good = models.CharField(max_length=100,blank=True)
    dc_note = models.TextField(blank=True)
    dc_total = models.CharField(max_length=100,blank=True)
    gst_option = models.CharField(max_length=100,blank=True)
    ...
    dc_freight_amount = models.CharField(max_length=100,blank=True)
    dc_freight_percentage = models.CharField(max_length=100,blank=True)
    ...
    dc_freight_percentage_amt = models.CharField(max_length=100,blank=True)
    ...
    dc_freight_amt_amt = models.CharField(max_length=100,blank=True,null=True)
...
class Invoice(models.Model):
    ...
    invoice_landing_LR_RR_No = models.CharField(max_length=100,blank=True)
    ...
    # invoice_freight = models.CharField(max_length=100,blank=True)
    invoice_sub_total = models.CharField(max_length=100,blank=True)
    invoice_cgstper = models.CharField(max_length=100,blank=True)
    invoice_cgstval = models.CharField(max_length=100,blank=True)
    invoice_sgstper = models.CharField(max_length=100,blank=True)
    invoice_sgstval = models.CharField(max_length=100,blank=True)
    invoice_igstper = models.CharField(max_length=100,blank=True)
    invoice_igstval = models.CharField(max_length=100,blank=True)
    invoice_adjustment = models.CharField(max_length=100,blank=True)
    invoice_sale_of_good = models.CharField(max_length=100,blank=True)
    invoice_note = models.TextField(blank=True)
    invoice_total = models.CharField(max_length=100,blank=True)
    gst_option = models.CharField(max_length=100,blank=True)
    ...
    inv_freight_amount = models.CharField(max_length=100,blank=True)
    inv_freight_percentage = models.CharField(max_length=100,blank=True)
    inv_packaging_forwording_percentage_amt = models.CharField(max_length=512,blank=True)
    inv_freight_percentage_amt = models.CharField(max_length=100,blank=True)
    ...
    inv_freight_amt_amt = models.CharField(max_length=100,blank=True,null=True)
...
class Credit_Notes(models.Model):
    ...
    cn_landing_LR_RR_No = models.CharField(max_length=100,blank=True)
    cn_shipping_address = models.CharField(max_length=256,blank=True)
    # cn_freight = models.CharField(max_length=100,blank=True)
    # cn_sales_person = models.CharField(max_length=256,blank=True)
    cn_sub_total = models.CharField(max_length=100,blank=True)
    cn_cgstper = models.CharField(max_length=100,blank=True)
    cn_cgstval = models.CharField(max_length=100,blank=True)
    cn_sgstper = models.CharField(max_length=100,blank=True)
    cn_sgstval = models.CharField(max_length=100,blank=True)
    cn_igstper = models.CharField(max_length=100,blank=True)
    cn_igstval = models.CharField(max_length=100,blank=True)
    cn_adjustment = models.CharField(max_length=100,blank=True)
    # cn_sale_of_good = models.CharField(max_length=100,blank=True)
    cn_note = models.TextField(blank=True)
    cn_total = models.CharField(max_length=100,blank=True)
    cn_ser_type = models.CharField(max_length=100,blank=True)
    gst_option = models.CharField(max_length=100,blank=True)
    ...
    cn_freight_amount = models.CharField(max_length=100,blank=True)
    cn_freight_percentage = models.CharField(max_length=100,blank=True)
    cn_packaging_forwording_percentage_amt = models.CharField(max_length=512,blank=True)
    cn_freight_percentage_amt = models.CharField(max_length=100,blank=True)
    ...
    cn_freight_amt_amt = models.CharField(max_length=100,blank=True,null=True)
...
class Purchase_order(models.Model):
    ...
    # po_freight = models.CharField(max_length=100,blank=True)
    # po_sales_person = models.CharField(max_length=256,blank=True)
    po_sub_total = models.CharField(max_length=100,blank=True)
    po_cgstper = models.CharField(max_length=100,blank=True)
    po_cgstval = models.CharField(max_length=100,blank=True)
    po_sgstper = models.CharField(max_length=100,blank=True)
    po_sgstval = models.CharField(max_length=100,blank=True)
    po_igstper = models.CharField(max_length=100,blank=True)
    po_igstval = models.CharField(max_length=100,blank=True)
    po_adjustment = models.CharField(max_length=100,blank=True)
    # po_sale_of_good = models.CharField(max_length=100,blank=True)
    po_note = models.TextField(blank=True)
    po_total = models.CharField(max_length=100,blank=True)
    gst_option = models.CharField(max_length=100,blank=True)
    ...
    po_freight_amount = models.CharField(max_length=100,blank=True)
    po_freight_percentage = models.CharField(max_length=100,blank=True)
    po_packaging_forwording_percentage_amt = models.CharField(max_length=512,blank=True)
    po_freight_percentage_amt = models.CharField(max_length=100,blank=True)
    ...
    po_freight_amt_amt = models.CharField(max_length=100,blank=True,null=True)
...
class Goods_received_notes(models.Model):
    ...
    grn_freight = models.CharField(max_length=100,blank=True)
    # grn_sales_person = models.CharField(max_length=256,blank=True)
    grn_sub_total = models.CharField(max_length=100,blank=True)
    grn_cgstper = models.CharField(max_length=100,blank=True)
    grn_cgstval = models.CharField(max_length=100,blank=True)
    grn_sgstper = models.CharField(max_length=100,blank=True)
    grn_sgstval = models.CharField(max_length=100,blank=True)
    grn_igstper = models.CharField(max_length=100,blank=True)
    grn_igstval = models.CharField(max_length=100,blank=True)
    grn_adjustment = models.CharField(max_length=100,blank=True)
    # grn_sale_of_good = models.CharField(max_length=100,blank=True)
    grn_note = models.TextField(blank=True)
    grn_total = models.CharField(max_length=100,blank=True)
    gst_option = models.CharField(max_length=100,blank=True)
    ...
    grn_freight_amount = models.CharField(max_length=100,blank=True)
    grn_freight_percentage = models.CharField(max_length=100,blank=True)
    totalamt_word = models.CharField(max_length=250,blank=True)
    grn_packaging_forwording_percentage_amt = models.CharField(max_length=512,blank=True)
    grn_freight_percentage_amt = models.CharField(max_length=100,blank=True)
    grn_packaging_forwording_amt_amt = models.CharField(max_length=512,blank=True)
    grn_freight_percentage_amt_amt = models.CharField(max_length=100,blank=True)
...
class acc_expense(models.Model):
    ...
    acc_gst = models.CharField(max_length=100,blank=True)
    acc_freight = models.CharField(max_length=100,blank=True)
    acc_total = models.CharField(max_length=100, blank = True)
    class Meta:
...
class Purchase_Invoice(models.Model):
    ...
    # purchase_invoice_freight = models.CharField(max_length=100,blank=True)
    purchase_invoice_sub_total = models.CharField(max_length=100,blank=True)
    purchase_invoice_cgstper = models.CharField(max_length=100,blank=True)
    purchase_invoice_cgstval = models.CharField(max_length=100,blank=True)
    purchase_invoice_sgstper = models.CharField(max_length=100,blank=True)
    purchase_invoice_sgstval = models.CharField(max_length=100,blank=True)
    purchase_invoice_igstper = models.CharField(max_length=100,blank=True)
    purchase_invoice_igstval = models.CharField(max_length=100,blank=True)
    purchase_invoice_adjustment = models.CharField(max_length=100,blank=True)
    purchase_invoice_note = models.TextField(blank=True)
    purchase_invoice_total = models.CharField(max_length=100,blank=True)
    ...
    purchase_freight_amount = models.CharField(max_length=100,blank=True)
    purchase_freight_percentage = models.CharField(max_length=100,blank=True)
    gst_option= models.CharField(null=True,max_length=100)
    cn_packaging_forwording_percentage_amt = models.CharField(max_length=100,blank=True)
    cn_freight_percentage_amt = models.CharField(max_length=100,blank=True)
    cn_total_amt_word = models.CharField(max_length=100,blank=True)
    cn_packaging_forwording_amt_amt = models.CharField(max_length=100,blank=True)
    cn_freight_percentage_amt_amt = models.CharField(max_length=100,blank=True)
...
class Performa_Invoice(models.Model):
    ...
    invoice_note = models.TextField(blank=True)
    invoice_total = models.CharField(max_length=100,blank=True)
    invoice_ser_type = models.CharField(max_length=100,blank=True)
    invoice_status = models.CharField(max_length=100, default='Received')
    invoice_due = models.CharField(max_length=100,blank=True)
    gst_option = models.CharField(max_length=100,blank=True)
    cn_packaging_forwording_amount = models.CharField(max_length=512,blank=True)
    cn_packaging_forwording_percentage = models.CharField(max_length=512,blank=True)
    cn_freight_amount = models.CharField(max_length=100,blank=True)
    cn_freight_percentage = models.CharField(max_length=100,blank=True)
    pi_number = models.CharField(max_length=100,blank=True)
    cn_packaging_forwording_percentage_amt = models.CharField(max_length=100,blank=True)
    cn_freight_percentage_amt = models.CharField(max_length=100,blank=True)
    cn_total_amt_word = models.CharField(max_length=100,blank=True)
    cn_packaging_forwording_amt_amt = models.CharField(max_length=100,blank=True)
    cn_freight_percentage_amt_amt = models.CharField(max_length=100,blank=True)
    inv_Dispatch_document_no = models.CharField(max_length=100,blank=True,null=True)
...
class Leads(models.Model):
    id = models.AutoField(primary_key=True, editable=False)
    l_LS_NO = models.CharField(max_length=100, null=True,blank=True)  
    ...
    leads_ser_type = models.CharField(max_length=100,blank=True,null=True)
    date = models.DateField(null=True)
